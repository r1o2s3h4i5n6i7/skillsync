        ...
        {SORTED_STUDENTS.length >= 3 && (
          <div className="flex items-end justify-center gap-3 py-4">
            ...
            <motion.div
              ...
              <div className="w-12 h-12 brand-gradient rounded-2xl flex items-center justify-center text-white font-bold mx-auto mb-2 shadow-md shadow-pink-500/25">
            ...
            <motion.div
              ...
              <div className="w-14 h-14 brand-gradient rounded-2xl flex items-center justify-center text-white font-bold mx-auto mb-2 shadow-lg shadow-pink-500/30 text-lg">
